...
> 📝 **Translation status**: this English README covers the user-facing core (pain points / effects / principles / performance / install / FAQ). Full translation of all auxiliary docs (CHANGELOG / SECURITY / docs/*.md) lands in v0.5.3 per [`docs/REFACTOR_PLAN_RULE_AND_I18N.md`](./docs/REFACTOR_PLAN_RULE_AND_I18N.md).
